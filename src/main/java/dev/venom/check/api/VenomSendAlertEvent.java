...
*/
public class VenomSendAlertEvent extends Event implements Cancellable {
    ...
    public VenomSendAlertEvent(final TextComponent message, final Player player, final VenomCheck check, final String info, final Category category) {
        super(true);
        this.player = player;
